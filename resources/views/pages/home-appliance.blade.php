                ...
                <div class="row position-left">
                    <div class="col-lg-9 col-md-8 col-12 pro-grli-wrap">
                        ...
                        <div class="collection-img-wrap">
                            <h6 class="st-title">HOME APPLIANCE</h6><div class="collection-info">
                                <div class="collection-image">

                                    <img class="img-fluid" src="//cdn.shopify.com/s/files/1/0509/6331/6893/collections/mega-menu_150x150_crop_center.jpg?v=1605005220" alt="Headphone"/>

                                </div>
                                <div class="collection-description">

                                    <p><span data-mce-fragment="1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ali...</p>
                        ...
                        <div class="get-data-products">
                            <div class="shop-grid"><div class="product-grid-view">
                                    <div class="shop-product-wrap grid-3">
                                        <div class="row">
                                            <div class="col">
                                                <ul class="product-view"><li class="st-col-item"><div class="single-product-wrap stock-out">
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/refrigerator" title="Refrigerator">Refrigerator</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/jbl-speaker" title="JBL Speaker">JBL Speaker</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/laptop" title="Laptop">Laptop</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/boat" title="Boat">Boat</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/i-phone" title="I Phone">I Phone</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/watch" title="Watch">Watch</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/earbuds" title="Earbuds">Earbuds</a>
                                                                </h6>
                                                                <div class="price-box">
                                                                    <span class="new-price"><span class=money>Rs. 120.00</span></span>
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/juice-machine" title="Juice machine">Juice machine</a>
                                                                </h6>
                                                                <div class="price-box">
                                                                    <span class="new-price"><span class=money>Rs. 150.00</span></span>
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/headphone" title="Headphone">Headphone</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/mouse" title="Mouse">Mouse</a>
                                                                </h6>
                                                                <div class="price-box">
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/camera" title="Camera">Camera</a>
                                                                </h6>
                                                                <div class="price-box">
                                                                    <span class="new-price"><span class=money>Rs. 150.00</span></span>
                ...
                <span>
                    ...
                    <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                            ...
                                                            <div class="product-content">
                                                                ...
                                                                <h6>
                                                                    <a href="/collections/headphone/products/pen-drive" title="Pen drive">Pen drive</a>
                                                                </h6>
                                                                <div class="price-box">
                                ...
                                <div class="shop-sidebar sidebar-wedget"><h6 class="title">Categories</h6>
                                    <a class="title" data-toggle="collapse" href="#collapse-Categories">Categories</a><div class="collapse scroll-top" id="collapse-Categories">
                                        <ul class="scrollbar">
                                            ...
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Camera"><a href="/collections/camera" class="cust-checkbox-label" title="Camera">
                                                    <span class="filter-name">Camera</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Computer"><a href="/collections/computer" class="cust-checkbox-label" title="Computer">
                                                    <span class="filter-name">Computer</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Deal Collection"><a href="/collections/deal-collection" class="cust-checkbox-label" title="Deal Collection">
                                                    <span class="filter-name">Deal Collection</span>
                                                    <span class="count-check">3</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Electronic"><a href="/collections/electronic" class="cust-checkbox-label" title="Electronic">
                                                    <span class="filter-name">Electronic</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Featured products"><a href="/collections/featured-products" class="cust-checkbox-label" title="Featured products">
                                                    <span class="filter-name">Featured products</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class="active"><input type="checkbox" checked="checked" name="Headphone" class="cust-checkbox"><a href="/collections/headphone" class="cust-checkbox-label" title="Headphone">
                                                    <span class="filter-name">Headphone</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Home Appliance"><a href="/collections/home-appliance" class="cust-checkbox-label" title="Home Appliance">
                                                    <span class="filter-name">Home Appliance</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Laptop"><a href="/collections/laptop" class="cust-checkbox-label" title="Laptop">
                                                    <span class="filter-name">Laptop</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="New products"><a href="/collections/new-products" class="cust-checkbox-label" title="New products">
                                                    <span class="filter-name">New products</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Pen Drives"><a href="/collections/pen-drives" class="cust-checkbox-label" title="Pen Drives">
                                                    <span class="filter-name">Pen Drives</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Refrigerator"><a href="/collections/refrigerator" class="cust-checkbox-label" title="Refrigerator">
                                                    <span class="filter-name">Refrigerator</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Smartphone"><a href="/collections/smartphone" class="cust-checkbox-label" title="Smartphone">
                                                    <span class="filter-name">Smartphone</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Speakers"><a href="/collections/speakers" class="cust-checkbox-label" title="Speakers">
                                                    <span class="filter-name">Speakers</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="Special Produts"><a href="/collections/special-produts" class="cust-checkbox-label" title="Special Produts">
                                                    <span class="filter-name">Special Produts</span>
                                                    <span class="count-check">12</span>
                                                    <span class="cust-check"></span>
                                                </a>
                                            </li>
                                            <li class=""><input type="checkbox" class="cust-checkbox" name="VR Box"><a href="/collections/vr-box" class="cust-checkbox-label" title="VR Box">
                                            ...
                                            <ul class="multiple-filters scrollbar">
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_blue" data-remove-tag="blue" name="color" value="color_blue" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_blue" data-remove-tag="blue"  style="background: blue no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_brown" data-remove-tag="brown" name="color" value="color_brown" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_brown" data-remove-tag="brown"  style="background: brown no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_gold" data-remove-tag="gold" name="color" value="color_gold" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_gold" data-remove-tag="gold"  style="background: gold no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_gray" data-remove-tag="gray" name="color" value="color_gray" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_gray" data-remove-tag="gray"  style="background: gray no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_green" data-remove-tag="green" name="color" value="color_green" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_green" data-remove-tag="green"  style="background: green no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_pink" data-remove-tag="pink" name="color" value="color_pink" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_pink" data-remove-tag="pink"  style="background: pink no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_red" data-remove-tag="red" name="color" value="color_red" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_red" data-remove-tag="red"  style="background: red no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="color">
                                                    <label class="cust-checkbox-label color">
                                                        ...
                                                        <input type="checkbox" data-tag="color_whitesmoke" data-remove-tag="whitesmoke" name="color" value="color_whitesmoke" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="color_whitesmoke" data-remove-tag="whitesmoke"  style="background: whitesmoke no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                            ...
                                            <ul class="multiple-filters scrollbar">
                                                ...
                                                <li class="price">
                                                    <label class="cust-checkbox-label price">
                                                        ...
                                                        <input type="checkbox" data-tag="price_0-100" data-remove-tag="0-100" name="price" value="price_0-100" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="price_0-100" data-remove-tag="0-100"  style="background: 0-100 no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="price">
                                                    <label class="cust-checkbox-label price">
                                                        ...
                                                        <input type="checkbox" data-tag="price_100-200" data-remove-tag="100-200" name="price" value="price_100-200" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="price_100-200" data-remove-tag="100-200"  style="background: 100-200 no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="price">
                                                    <label class="cust-checkbox-label price">
                                                        ...
                                                        <input type="checkbox" data-tag="price_200-300" data-remove-tag="200-300" name="price" value="price_200-300" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="price_200-300" data-remove-tag="200-300"  style="background: 200-300 no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                            ...
                                            <ul class="multiple-filters scrollbar">
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_128gb" data-remove-tag="128gb" name="size" value="size_128gb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_128gb" data-remove-tag="128gb"  style="background: 128gb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_128MP" data-remove-tag="128MP" name="size" value="size_128MP" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_128MP" data-remove-tag="128MP"  style="background: 128MP no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_16gb" data-remove-tag="16gb" name="size" value="size_16gb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_16gb" data-remove-tag="16gb"  style="background: 16gb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_1l" data-remove-tag="1l" name="size" value="size_1l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_1l" data-remove-tag="1l"  style="background: 1l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_2l" data-remove-tag="2l" name="size" value="size_2l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_2l" data-remove-tag="2l"  style="background: 2l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_2tb" data-remove-tag="2tb" name="size" value="size_2tb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_2tb" data-remove-tag="2tb"  style="background: 2tb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_32gb" data-remove-tag="32gb" name="size" value="size_32gb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_32gb" data-remove-tag="32gb"  style="background: 32gb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_3l" data-remove-tag="3l" name="size" value="size_3l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_3l" data-remove-tag="3l"  style="background: 3l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_3tb" data-remove-tag="3tb" name="size" value="size_3tb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_3tb" data-remove-tag="3tb"  style="background: 3tb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_48MP" data-remove-tag="48MP" name="size" value="size_48MP" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_48MP" data-remove-tag="48MP"  style="background: 48MP no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_4l" data-remove-tag="4l" name="size" value="size_4l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_4l" data-remove-tag="4l"  style="background: 4l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_4tb" data-remove-tag="4tb" name="size" value="size_4tb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_4tb" data-remove-tag="4tb"  style="background: 4tb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_5l" data-remove-tag="5l" name="size" value="size_5l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_5l" data-remove-tag="5l"  style="background: 5l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_64gb" data-remove-tag="64gb" name="size" value="size_64gb" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_64gb" data-remove-tag="64gb"  style="background: 64gb no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_64MP" data-remove-tag="64MP" name="size" value="size_64MP" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_64MP" data-remove-tag="64MP"  style="background: 64MP no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="size">
                                                    <label class="cust-checkbox-label size">
                                                        ...
                                                        <input type="checkbox" data-tag="size_6l" data-remove-tag="6l" name="size" value="size_6l" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="size_6l" data-remove-tag="6l"  style="background: 6l no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                            ...
                                            <ul class="multiple-filters scrollbar">
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_camera" data-remove-tag="camera" name="tag" value="tag_camera" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_camera" data-remove-tag="camera"  style="background: camera no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_earphone" data-remove-tag="earphone" name="tag" value="tag_earphone" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_earphone" data-remove-tag="earphone"  style="background: earphone no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_headphone" data-remove-tag="headphone" name="tag" value="tag_headphone" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_headphone" data-remove-tag="headphone"  style="background: headphone no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_Juice-machine" data-remove-tag="Juice-machine" name="tag" value="tag_Juice-machine" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_Juice-machine" data-remove-tag="Juice-machine"  style="background: Juice-machine no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_laptop" data-remove-tag="laptop" name="tag" value="tag_laptop" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_laptop" data-remove-tag="laptop"  style="background: laptop no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_mouse" data-remove-tag="mouse" name="tag" value="tag_mouse" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_mouse" data-remove-tag="mouse"  style="background: mouse no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_pen-drive" data-remove-tag="pen-drive" name="tag" value="tag_pen-drive" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_pen-drive" data-remove-tag="pen-drive"  style="background: pen-drive no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_refrigerator" data-remove-tag="refrigerator" name="tag" value="tag_refrigerator" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_refrigerator" data-remove-tag="refrigerator"  style="background: refrigerator no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_speaker" data-remove-tag="speaker" name="tag" value="tag_speaker" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_speaker" data-remove-tag="speaker"  style="background: speaker no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
                                                ...
                                                <li class="tag">
                                                    <label class="cust-checkbox-label tag">
                                                        ...
                                                        <input type="checkbox" data-tag="tag_watch" data-remove-tag="watch" name="tag" value="tag_watch" class="cust-checkbox">

                                                        <span class="cust-check" data-tag="tag_watch" data-remove-tag="watch"  style="background: watch no-repeat center; background-size: initial;"></span>
                                                    </label>
                                                </li>
